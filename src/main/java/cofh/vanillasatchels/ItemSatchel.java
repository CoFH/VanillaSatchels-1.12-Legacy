...
public class ItemSatchel extends ItemMulti implements IInitializer, IColorableItem, IEnchantableItem, IInventoryContainerItem, IMultiModeItem {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(StringHelper.getInfoText("info.vanillaplus.satchel.a.0"));
		tooltip.add(StringHelper.localize("info.vanillaplus.satchel.a.1"));
		tooltip.add(StringHelper.getNoticeText("info.vanillaplus.satchel.a.2"));
		tooltip.add(StringHelper.localizeFormat("info.vanillaplus.satchel.b." + getMode(stack), StringHelper.getKeyName(KeyBindingItemMultiMode.INSTANCE.getKey())));
		...
		if (ServerHelper.isServerWorld(world)) {
			...
			if (canPlayerAccess(stack, player)) {
				if (player.isSneaking() && ItemHelper.getItemDamage(stack) != CREATIVE) {
					player.openGui(VanillaSatchels.instance, GuiHandler.SATCHEL_FILTER_ID, world, 0, 0, 0);
				} else {
					player.openGui(VanillaSatchels.instance, GuiHandler.SATCHEL_ID, world, 0, 0, 0);
				}
	...
	public void onModeChange(EntityPlayer player, ItemStack stack) {
		...
		ChatHelper.sendIndexedChatMessageToPlayer(player, new TextComponentTranslation("info.vanillaplus.satchel.c." + getMode(stack)));
	}
	...
	public boolean initialize() {
		...
		addShapelessSecureRecipe(satchelBasic, satchelBasic, Blocks.OBSIDIAN);
		addShapelessSecureRecipe(satchelIron, satchelIron, Blocks.OBSIDIAN);
		addShapelessSecureRecipe(satchelGold, satchelGold, Blocks.OBSIDIAN);
		addShapelessSecureRecipe(satchelDiamond, satchelDiamond, Blocks.OBSIDIAN);
		addShapelessSecureRecipe(satchelResonant, satchelResonant, Blocks.OBSIDIAN);

		addColorRecipe(satchelBasic, satchelBasic, "dye");
		addColorRecipe(satchelIron, satchelIron, "dye");
		addColorRecipe(satchelGold, satchelGold, "dye");
		addColorRecipe(satchelDiamond, satchelDiamond, "dye");
		addColorRecipe(satchelResonant, satchelResonant, "dye");

		addColorRecipe(satchelBasic, satchelBasic, "dye", "dye");
		addColorRecipe(satchelIron, satchelIron, "dye", "dye");
		addColorRecipe(satchelGold, satchelGold, "dye", "dye");
		addColorRecipe(satchelDiamond, satchelDiamond, "dye", "dye");
		addColorRecipe(satchelResonant, satchelResonant, "dye", "dye");

		addColorRemoveRecipe(satchelBasic, satchelBasic);
		addColorRemoveRecipe(satchelIron, satchelIron);
		addColorRemoveRecipe(satchelGold, satchelGold);
		addColorRemoveRecipe(satchelDiamond, satchelDiamond);
